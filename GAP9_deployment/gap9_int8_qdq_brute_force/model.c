...
void model_int8_qdqModel(unsigned int L1Memory, unsigned int L2Memory, unsigned int L3Memory, unsigned int L3Flash)
{
    ...
    CNN_ConvolutionPoolAct_SQ8("S7__net_net_2_Conv", &gen_ctrl_S7__net_net_2_Conv,
                               4, 1,
                               9, 19, 224, 224,
    ...
    CNN_ConvolutionPoolAct_SQ8("S10__net_net_4_Conv", &gen_ctrl_S10__net_net_4_Conv,
                               4, 1,
                               19, 38, 112, 112,
                               KOP_CONV, 3, 3, 1, 1, 2, 2, 1,
                               KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionPoolAct_SQ8("S13__net_net_6_Conv", &gen_ctrl_S13__net_net_6_Conv,
                               4, 1,
                               38, 76, 56, 56,
                               KOP_CONV, 3, 3, 1, 1, 2, 2, 1,
                               KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionPoolAct_SQ8("S16__net_net_8_Conv", &gen_ctrl_S16__net_net_8_Conv,
                               4, 1,
                               76, 76, 28, 28,
                               KOP_CONV, 3, 3, 1, 1, 1, 1, 1,
                               KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
...
#define GRAPH
    ...
    // Node S4__net_net_0_Conv inq -2.12<(i8--13.00)*0.01845340<2.58 weightsq chan<(i8-0.00)*chan<chan outq 0.00<(i8--128.00)*0.00954214<2.43 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S7__net_net_2_Conv inq 0.00<(i8--128.00)*0.00954214<2.43 weightsq chan<(i8-0.00)*chan<chan outq 0.00<(i8--128.00)*0.00399878<1.02 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S10__net_net_4_Conv inq 0.00<(i8--128.00)*0.00399878<1.02 weightsq chan<(i8-0.00)*chan<chan outq 0.00<(i8--128.00)*0.00069478<0.18 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S13__net_net_6_Conv inq 0.00<(i8--128.00)*0.00069478<0.18 weightsq chan<(i8-0.00)*chan<chan outq 0.00<(i8--128.00)*0.00039254<0.10 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S16__net_net_8_Conv inq 0.00<(i8--128.00)*0.00039254<0.10 weightsq chan<(i8-0.00)*chan<chan outq -0.01<(i8-12.00)*0.00008462<0.01 biasesq chan<(i32-0.00)*chan<chan
