...
AT_DEFAULTFLASH_EXT_ADDR_TYPE network_L3_Flash = 0;
...
/* Outputs */
L2_MEM unsigned char Output_1[59584];
...
static void cluster(void * arg)
{
    ...
    networkCNN_ConstructCluster();
GPIO_HIGH();
    networkCNN(Input_1, Output_1);
GPIO_LOW();
...
int main(int argc, char *argv[])
{
    ...
    printf("Constructor\n");
    int ConstructorErr = networkCNN_Construct();
    if (ConstructorErr)
    {
