...
#define GRAPH
    ...
    // Node S7__net_net_2_Conv inq -2.45<(i8-0.00)*0.01915942<2.43 forced weightsq chan<(i8-0.00)*chan<chan outq -1.03<(i8-0.00)*0.00802905<1.02 forced biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S10__net_net_4_Conv inq -1.03<(i8-0.00)*0.00802905<1.02 forced weightsq chan<(i8-0.00)*chan<chan outq -0.18<(i8-0.00)*0.00139503<0.18 forced biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S13__net_net_6_Conv inq -0.18<(i8-0.00)*0.00139503<0.18 forced weightsq chan<(i8-0.00)*chan<chan outq -0.10<(i8-0.00)*0.00078817<0.10 forced biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S16__net_net_8_Conv inq -0.10<(i8-0.00)*0.00078817<0.10 forced weightsq chan<(i8-0.00)*chan<chan outq -0.01<(i8-0.00)*0.00009256<0.01 forced biasesq chan<(i32-0.00)*chan<chan
