...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "model_int8_qdq"
...
#define AI_NETWORK_IN_1_CHANNEL     (224)
...
#define AI_NETWORK_OUT_1_HEIGHT      (28)
#define AI_NETWORK_OUT_1_WIDTH       (76)
#define AI_NETWORK_OUT_1_CHANNEL     (28)
#define AI_NETWORK_OUT_1_SIZE        (59584)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (59584)
